...
!function(){$(document).foundation(),$(document).ready(function(){if(Modernizr.svg||$("img[src$='.svg']").each(function(){$(this).attr("src",$(this).data("fallback"))}),matchMedia&&window.matchMedia("(max-device-width: 768px), (max-device-width: 1024px) and (orientation: portrait)").matches)for(var inputs=document.getElementsByClassName("mobile-numpad"),i=0;i<inputs.length;i++)inputs[i].setAttribute("pattern","[0-9]*"),inputs[i].setAttribute("type","number");$("a[rel=external]").click(function(){return window.open($(this).attr("href")),!1}),$(".article-main").slick({slidesToShow:1,slidesToScroll:1,dots:!0,infinite:!0,speed:500,fade:!0,cssEase:"linear",autoplay:!0,prevArrow:$(".article-left"),nextArrow:$(".article-right"),responsive:[{breakpoint:1024,settings:{dots:!1}}]}),$(".right-off-canvas-toggle").on("click",function(){$(this).toggleClass("menu-open")})})}();